...
namespace sds
{
	...
	//-------------------------------------------------------------------------
	fstreamNsud::fstreamNsud( const char *fullpath, FileOpenMode mode, const bool bFromBundle ) :
		m_data( 0 ),
		m_offset( 0 ),
		m_size( 0 ),
		m_statusBits( 0 ),
	...
	//-------------------------------------------------------------------------
	fstreamNsud::fstreamNsud( const std::string &fullpath, FileOpenMode mode, const bool bFromBundle ) :
		m_data( 0 ),
		m_offset( 0 ),
		m_size( 0 ),
		m_statusBits( 0 ),
	...
	//-------------------------------------------------------------------------
	void fstreamNsud::open( const std::string &fullpath, FileOpenMode mode, const bool bFromBundle )
	{
		open( fullpath.c_str(), mode, bFromBundle );
	}
	//-------------------------------------------------------------------------
	void fstreamNsud::open( const char *fullpath, FileOpenMode mode, const bool )
	{
		close();
	...
	//-------------------------------------------------------------------------
	void fstreamNsud::seek( ptrdiff_t dir, Whence whence )
	{
		if( !good() )
		{
			m_statusBits |= fstreamNsud::failbit;
