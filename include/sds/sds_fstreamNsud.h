...
namespace sds
{
	...
	*/
	...
	public:
		fstreamNsud();
		fstreamNsud( const std::string &fullpath, FileOpenMode mode, const bool bFromBundle = true );
		fstreamNsud( const char *fullpath, FileOpenMode mode, const bool bFromBundle = true );
		~fstreamNsud();
